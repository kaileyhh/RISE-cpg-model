...
for i in range(c.iterations):
    synapse.calculate_sensory_all(
        i, 1.0, 1.0, sensory_vec[i])  # , 5.0, 0.0, 1)
...
ax1.title.set_text(
    "Neuron 1 (red, I = " + str(neuron1.current) + " ), x0 = " + str(neuron1.xR))
ax1.set_xlabel("time (ms)")
ax1.set_ylabel("au")
ax2.title.set_text(
    "Neuron 2 (green, I = " + str(neuron2.current) + " ), x0 = " + str(neuron2.xR))
...
fig.suptitle(
    "2 coupled neurons (I = 1.4); neuron 1 receives sensory excitation for 200ms")
