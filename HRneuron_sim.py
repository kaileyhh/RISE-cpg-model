...
peaks2, other = find_peaks(neuron2.xarr, height=c.MIN_HEIGHT,
                           threshold=0, distance=c.MIN_DISTANCE, width=c.MIN_WIDTH)
...
for j in range(124*1000, 125*1000, 1000):
    ...
    peaks1, other = find_peaks(neuron1.xarr, height=c.MIN_HEIGHT,
                               threshold=0, distance=c.MIN_DISTANCE, width=c.MIN_WIDTH)
...
ax1.plot(time_vec[min_bound:max_bound],
         neuron1.xarr[min_bound:max_bound], linewidth=0.5, color="red")
# ax1.plot(peaks1, neuron1.xarr[peaks1], "x")
ax2.plot(time_vec[min_bound:max_bound],
         neuron2.xarr[min_bound:max_bound], linewidth=0.5, color="green")
# ax2.plot(peaks2, neuron2.xarr[peaks2], "x")
ax3.plot(time_vec[min_bound:max_bound],
         neuron1.xarr[min_bound:max_bound], linewidth=0.5, color="red")
ax3.plot(time_vec[min_bound:max_bound],
         neuron2.xarr[min_bound:max_bound], linewidth=0.5, color="green")
ax4.plot(time_vec[min_bound:max_bound], neuron1.xarr[min_bound:max_bound] -
         neuron2.xarr[min_bound:max_bound], linewidth=0.5, color="black")
...
fig.suptitle(
    "2 uncoupled neurons (I = 1.4); neuron 1 receives sensory excitation for 200ms")
